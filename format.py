...
def get_difficulty_colour(difficulty):
    ...
    return colours.get(difficulty.lower(), (255, 255, 255))
...
def format_drop_table_lines(tiered_drop_table, label="Drops:"):
    ...
    # Normalize legacy flat list into a "common" tier
    if isinstance(tiered_drop_table, list):
        tiered_drop_table = {"common": tiered_drop_table}
